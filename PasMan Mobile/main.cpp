...
int main(int argc, char *argv[])
{
    ...
    // Gets the default app data location for currecnt OS
    ...
    int logoWidth = min(screenWidth, screenHeight) / 2;
    ...
    QPixmap logoPixmap(":/images/logo.png"); // Loads the image
    logoLabel->setPixmap(logoPixmap);
    logoLabel->setPixmap(logoPixmap.scaled(logoWidth, logoWidth, Qt::KeepAspectRatio, Qt::SmoothTransformation)); // Adds the image to the logoLabel
